...
# Remove bottom links
#skills = soup.find(class_='skills-statement-container')
#skills.decompose()
...
skills_statement_list = soup.find(class_='skill-statement')

# Pull text from all instances of <a> tag within BodyText div
skills_statement_list_items = skills_statement_list.find_all('a')

# Create for loop to print out all artists' names
for skills_statement in skills_statement_list_items:
    text = skills_statement_list.contents[0]
